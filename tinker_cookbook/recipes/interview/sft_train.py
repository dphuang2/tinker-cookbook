...
USER_INSTRUCTION_SUFFIX = (
    " Reason carefully step by step, then write your final answer in "
    "\\boxed{} format. Don't think for too long unnecessarily, especially "
    "when you have a reasonable degree of confidence. The checkpoint tool "
    "is available for tracking progress on hard multi-step problems, but "
    "use it sparingly -- only when you genuinely change approach or finish "
    "a substantial sub-task. For simple problems, just think and answer "
